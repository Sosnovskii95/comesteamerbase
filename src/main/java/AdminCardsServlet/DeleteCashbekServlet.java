...
@WebServlet(name = "DeleteCashbekServlet",urlPatterns = "/adminview/deletecashbektranzakt")
public class DeleteCashbekServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        saleSumService.deleteSaleSum(id_sale);
